...
public class Session extends ApiResource implements HasId {
   ...
   * and invoices with this {@code on_behalf_of} will appear in the portal. For more information,
   * see the <a href="https://stripe.com/docs/connect/charges-transfers#on-behalf-of">docs</a>.
   */
